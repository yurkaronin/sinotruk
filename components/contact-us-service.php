  ...
  <div class="wrapper">
    <div class="section-grid__content">
      <div class="section-grid__left">
        <h2 class="title title--mod">Запись на&nbsp;сервис</h2>
      ...
      <div class="section-grid__right">
        <form action="#" id="customForm" name="form" onsubmit="alert('submit!');return false">
          <ul class="list-reset content-grid">
            ...
            <li class="content-grid__card">
              <label for="name">Желаемая дата:</label>
              <div class="input-wrap">
            ...
            <li class="content-grid__card">
              <label for="name">Желаемое время:</label>
              <div class="input-wrap">
            ...
            <li class="content-grid__card content-grid__card--big">
              <label for="name">Марка, модель, год выпуска вашего авто:</label>
              <div class="input-wrap">
              <input type="text" id="name" name="details" placeholder="Введите информацию об автомобиле">
              </div>
            </li>
